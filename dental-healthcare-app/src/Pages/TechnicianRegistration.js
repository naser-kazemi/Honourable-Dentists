...
function TechnicianRegistration() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/users/register/technician/', {
                first_name: formData.firstName,
                last_name: formData.lastName,
                certification_number: formData.certificateNum,
            ...
            <main
                ...
                <section className="flex flex-col pt-6 mt-24 mb-14 max-w-full w-[448px] max-md:my-10">
                    ...
                    <form className="flex flex-col mt-8 text-sm max-md:max-w-full" onSubmit={handleSubmit}>
                        ...
                        <FormInput id="certificateNum" label="Certificate Number" value={formData.certificateNum} onChange={handleChange} />
