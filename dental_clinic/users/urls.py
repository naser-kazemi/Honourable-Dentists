...
urlpatterns = [
    path('patients/', PatientProfileListCreateView.as_view(),
         name='patient-list-create'),
    path('dentists/', DentistProfileListCreateView.as_view(),
    ...
    path('register/patient_form/', register_patient_form,
         name='register-patient-form'),
